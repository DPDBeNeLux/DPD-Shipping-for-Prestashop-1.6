...
class AdminCarrierWizardController extends AdminCarrierWizardControllerCore
{
	...
	{
		parent::setMedia();
		$this->addJs(_PS_MODULE_DIR_ . 'dpdbenelux' . DS . 'views' . DS . 'js' . DS . 'dpd_carrier_wizard.js');
	}
	...
	public function updateOtherDelivery($current_carrier_id, $new_carrier_id, $id_shop = NULL, $id_shop_group = NULL)
	{
		...
		Db::getInstance()->update('delivery', array('id_carrier' => pSQL($new_carrier_id)), ' id_carrier = ' .  pSQL($current_carrier_id)  . ' AND' . $where );
	}
